  ...
  return (
    <>
        <div id="gameGridContainer" className='relative h-[310px]'>
          <div id="whiteGrid" className='bg-white h-full rounded-[20px] border-[3px] border-black grid grid-cols-7 w-[335px] px-[10px] pt-[10px] pb-8 justify-items-center items-center'>
